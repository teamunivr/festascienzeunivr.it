                                ...
                                foreach ($photos as $photo) {
                                    if (pathinfo($photo, PATHINFO_EXTENSION) != "jpg") continue; ?> 
                                        <div class="photo-item type1">
                                            <a href="assets/img/gallery/<? echo $year ?>/<? echo $photo ?>" rel="prettyPhoto[gallery]">
                                                <img class="lazyimg-responsive" data-original="assets/img/gallery/<?php echo $year ?>/thumbs/<?php echo $photo ?>"/>
                                            </a>
                                        </div>  
                            <?php } ?>
                        </div>
