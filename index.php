    	...
    	<div class="home-inner">
            ...
            <div id="flex-home" class="flexslider">
                ...
                <ul class="slides">
                    <?php if(true) { ?>
                	<li> 
                    	<div id="DateCountdown" data-date="2019-06-07 18:30:00" style="width: 1140px; height: 390px;"></div>
	...
	<div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-8">
				...
				<br>
				<a><img style="max-width: 100%; display: block; margin: auto;" src="/assets/img/paginaincostruzione.jpg"></a>
