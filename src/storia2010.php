...
<section id="blog">
	...
	* l'intera macchina part&igrave; nel febbraio 2010, ben 4 mesi prima dell'evento;
	<br />
	* si pens&ograve; inoltre di introdurre stand e gazebi che potessero "salvare" momentaneamente la cassa, la piastra ed i vari allestimenti in caso di pioggia.
	<br>
	<br />
	...
	<br >
	<br/>
	Dopo gli sforzi di un anno vanificati dal tempo avverso, non fu facile trovare le energie per rimettersi di nuovo in gioco in un impresa simile. 
