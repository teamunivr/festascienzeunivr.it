...
<html>
	...
	<body>
        ...
        if(!(isset($_GET['aa']) && isset($_GET['n']))){
			die("Si è verificato un errore, controllare di essere arrivati a questa pagina tramite un link corretto!");
			return 0;
		 }
    	...
    	<div class="row">
           ...
           <div class="col-lg-6 col-md-6 col-sm-6">
           	<ul>
                  ...
                  <li><a href="news.php?aa=<?php echo($info['anno']); ?>&n=<?php echo($info['nome']); ?>">News</a></li>
              </ul>
           </div>
       	</div>
	</div>
        ...
        <div class="row">       	
            <div class="col-lg-9 col-md-9 col-sm-9">
            	<article class="latest-post detail">
              		<img src="assets/img/news/<?php echo($info['anno']); ?>/news_<?php echo($info['anno']); ?>_<?php echo($info['nome']); ?>.jpg" alt="dummy">
